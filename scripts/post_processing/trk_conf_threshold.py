...
def conf_thresholding(data_dir, save_dir, thres_dict):
	...
	save_dir_tmp = os.path.join(save_dir, 'label'); mkdir_if_missing(save_dir_tmp)
	for seq_file in seq_list:
...
if __name__ == '__main__':
	...
	print(f"Create {save_dir} with thresholding applied.")